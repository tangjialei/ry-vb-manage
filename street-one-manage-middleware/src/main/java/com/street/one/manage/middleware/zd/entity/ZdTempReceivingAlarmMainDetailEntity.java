...
/**
 * <p>
 * 接处警_案件基本信息详情(T-2)的数据，同步后会进行数据标记
 * </p>
 *
 * @author tjl
 * @since 2024-07-11
...
@TableName("zd_temp_receiving_alarm_main_detail")
public class ZdTempReceivingAlarmMainDetailEntity extends AbstractInfo implements Serializable {
